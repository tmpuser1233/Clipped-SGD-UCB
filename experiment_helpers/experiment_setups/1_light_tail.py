...
eps = 0.3
agents_partly = [
    lambda n_actions, R, K: agents.SGD_SMoM(n_actions=n_actions, R=R, K=K, m=0, n=1, coeff=0.07, init_steps=1),
    lambda n_actions, R, K: agents.SGD_SMoM(n_actions=n_actions, R=R, K=K, m=0, n=1, coeff=0.1, init_steps=1),
    lambda n_actions, R, K: agents.SGD_SMoM(n_actions=n_actions, R=R, K=K, m=0, n=1, coeff=0.12, init_steps=1),
